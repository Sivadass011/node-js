...
app.get("/list", (request, response) => {
  var sqlQuery = `SELECT * FROM SivaDass_S`;
...
app.post("/create", (request, response) => {
  ...
  var sqlQuery = `INSERT INTO SivaDass_S (name, age, location, email, blood_group) VALUES ('${name}', ${age}, '${_location}', '${email}', '${blood_group}')`;
